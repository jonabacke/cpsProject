 ...
 *
 * AuÃŸerdem sind die ausgehenden Transitionen vermerkt, da deren Trigger beim
 * Eintritt aktiviert und beim Verlassen deaktiviert werden mÃ¼ssen.
 */
public abstract class State {
    ...
    /**
     * FÃ¼gt neue Transition hinzu, wird nur von Transition aufgerufen!
     *
     * @param transition
     */
    ...
    /**
     * Kann von konkretem Zustand Ã¼berschrieben werden.
     */
    public void entry() {
    }
